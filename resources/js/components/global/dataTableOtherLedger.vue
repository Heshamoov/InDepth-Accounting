<template>
    <div>
        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                ...
                <div class="col-md-12  mt-2 mb-2" style="overflow-x: auto;" id="section-to-print" >
                    <div id="tableTop" style="display: none">
                        ...
                        <template v-if="$root.$data.company">
                            <h6 class="text-center">{{$root.$data.company.mobile}}<br>
                                {{$root.$data.company.address}}<br>
                            </h6>
                        </template>
                    </div>
                    <table class="table table-striped  table-fw-widget dataTable no-footer table_block ledgerTable" id="table1"
            ...
            <div class="center-screen" v-else> </div>
