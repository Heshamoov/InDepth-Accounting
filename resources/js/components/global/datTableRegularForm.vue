            ...
            <div class="row be-datatable-header card-header">
                <div class="col-md-12 d-flex justify-content-between  flex-wrap" id="adjustHeader">
                    ...
                    <div class="response_flex">
                        ...
                        <div class="search-container mr-2" v-if="dateSearch">
                            <button @click.prevent="assainSearchValue(),searched=true" class="btn btn-secondary pt-1">Search</button>
                        </div>
                        ...
                        <div class="printableArea" >
                            <a href="" @click.prevent="$parent.callModal(true)" class="headerIcon pt-1 pb-1">
            ...
            <div class="row be-datatable-body" v-if="dataList.length">
                <div class="col-md-12  mt-2 mb-2" style="overflow-x: auto;" id="section-to-print" >
                    <div id="tableTop" style="display: none">
                        ...
                        <h4 class="text-center">Day Sales List</h4>
                    ...
                    <table class="table table-striped  table-fw-widget dataTable no-footer table_block regularTable" id="table1"
                           role="grid" aria-describedby="table1_info" >
                        <thead>
                        <tr>
                            <th colspan="4" style="background: transparent"> </th>
                            <th colspan="4" style="background: #B2B1A8;"> <strong>Room Sales</strong></th>
                            <th style="background:#FA1100; color: #fff">Parking</th>
                            <th style="background:#FA1100"> </th>
                            <th colspan="" style="background:#FA1100; color: #fff">Internal A/C</th>
                            <th class=""> </th>
                            <th class="regular-head-print"> </th>
                            <th class="regular-head-print"> </th>
                            <th class="regular-head-print"> </th>
                        </tr>
                        <tr role="row tableHeader">
                            <th v-for="(column, index) in columns" class="text-center"
                                tabindex="0"
                                rowspan="1"
                                colspan="1"
                                :id="column.field"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="14" class="text-right" style="background:transparent">
