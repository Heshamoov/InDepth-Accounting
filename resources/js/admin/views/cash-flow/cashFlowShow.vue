        ...
        <div class="card p-4">
            <div class="col-md-12 mt-3 d-flex justify-content-end hideOnPrint">
                ...
                <div class="search-container ">
                    <button @click.prevent="getData(),previousBalace(),searched=true">Search</button>
                </div>
            </div>
            <div class="col-md-9 mx-auto pb-5" >
                ...
                <table align="center" id="section-to-print" class="profit_Table">
                    ...
                    <tbody>
                    <tr>
                        <td class="text-uppercase font-weight-bold">1:Opening Balance</td>
                        <td>{{openingBalance}}</td>

                    </tr>
                    <tr>
                        <td class="text-uppercase font-weight-bold" colspan="2">2:Turnover SALES</td>


                    </tr>
                    <tr v-for="income in incomes">
                        <td  class="pl-4 fs-13">{{income.name}}</td>
                        <td>{{income.amount!=null?income.amount:0}}</td>

                    </tr>

                    <tr>
                        <td class="font-weight-bold">3:Gross Cash Flow(1+2) </td>
                        <td  class="font-weight-bold">{{(Number(totalIncome)+ Number(openingBalance)).toFixed(2)}}</td>

                    </tr>

                    <tr>
                        <td class="font-weight-bold pl-2" colspan="2"> Overheads: </td>
                    </tr>
                    <tr v-for="item in expenses">
                        <td class="pl-4 fs-13">{{item.name}}</td>
                        <td>{{item.amount}}</td>
                    </tr>
                    ...
                    <tr>
                        <td class="font-weight-bold">4:Total Outgoing  </td>
                        <td class="font-weight-bold">{{totalOutgoing}}</td>

                    </tr>
                    <tr>
                        <td class="font-weight-bold pl-2" colspan="2" >Cash Flow Investing</td>

                    </tr>
                    <tr v-for="item in equity">
                        <td class="pl-4 fs-13">{{item.account}}</td>
                        <td>{{item.amount}}</td>
                    </tr>

                    <tr>
                        <td class="font-weight-bold">5:Total Investing  </td>
                        <td class="font-weight-bold">{{ownerInvestment}}</td>

                    </tr>


                    <tr>
                        <td class="font-weight-bold text-right">6:Closing Balance[(3+5)-4] </td>
