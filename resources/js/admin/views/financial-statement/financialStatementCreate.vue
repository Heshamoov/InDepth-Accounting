    ...
    <div>
        ...
        <div class="card p-4">
            <div class="col-md-12 mt-3 d-flex justify-content-end">
                ...
                <div class="search-container  mr-1">
                    <button @click.prevent="getData(),getProfitLossData(),getPreviouProfitLossData(),searched=true">Search</button>
            ...
            <div class="col-md-9 mx-auto pb-4">
                <div class="report_title">
                    ...
                    <span @click.prevent="printMe">  Print Now  <i class="fa fa-print fs-19 pl-1"></i></span>
                    <span @click.prevent="$root.downloadExcel('section-to-print')">  Download Excel  <i class="fa fa-file-excel-o pl-1"></i></span>
                </div>
                <table align="center" id="section-to-print" class="profit_Table">

                    <thead>
                    <tr>
                        <td colspan="4">
                            <div id="tableTop" style="display: none;text-align: center">
                                <h3 v-if="$root.$data.company">{{$root.$data.company.name}}</h3><br>
                    ...
                    <tbody>
                    <tr>
                        <td class="font-weight-bold" colspan="4">(1) Fixed Assets	</td>
                    </tr>
                          <tr>
                        <td class="pl-4 fs-13" colspan="3"> Tangible Asset</td>
                        <td>{{fixedAsset}}
                        </td>
                    </tr>
                  <!--  <tr v-for="fixedAsset in fixedAssets">
                    ...
                    <tr>
                        <td class="font-weight-bold" colspan="4">(2) Current  Assets</td>
                    </tr>
                    <tr>
                        <td class="pl-4 fs-13"> Cash in Hand</td>
                        <td>{{cashAmount}}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="pl-4 fs-13"> Cash at Bank</td>
                        <td>{{bankAmount}}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr v-for="currentAsset in currentAssets">
                        <td class="pl-4 fs-13"> {{currentAsset?currentAsset.name:''}}</td>
                        <td>{{
                    ...
                    <tr>
                        <td class="pl-4 fs-13"> Account Receivable</td>
                    ...
                    <template v-if="assetVat>0">
                        <tr>
                            <td class="pl-4 fs-13" colspan="2"> Others</td>
                        </tr>
                        <tr>
                            <td class="pl-5 fs-13" >Receivable VAT</td>
                            <td>{{assetVat}}</td>
                        </tr>
                    </template>
                    <tr>
                        <td class="font-weight-bold text-right" colspan="2">Total  Current Assets	</td>
                    ...
                    <!--</tr>-->
                    <tr>
                        <td class="font-weight-bold" colspan="4">(3) Short Term Liabilities	</td>

                    </tr>
                    <tr v-for="shortTermLiabilite in shortTermLiabilites">
                        <td class="pl-4 fs-13"> {{shortTermLiabilite?shortTermLiabilite.name:''}}</td>
                        <td>{{shortTermLiabilite.amount?shortTermLiabilite.amount:0}}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr >
                        <td class="pl-4 fs-13"> Accounts Payable</td>
                        <td>
                            {{accountsPayable}}
                        </td>
                        <td></td>
                    ...
                    <template v-if="liabilityVat>0">
                        ...
                        <tr>
                            <td class="pl-5 fs-13" >Paidable VAT</td>
                            <td>{{liabilityVat}}</td>
                            <td></td>
                            <td></td>
                        </tr>
                    ...
                    <tr>
                        <td class="font-weight-bold text-right" colspan="2">Total  Current Liabilites	</td>
                    ...
                    <tr>
                        <td class="font-weight-bold" colspan="3">(4) NET CURRENT ASSETS:(2 less 3=)</td>
                        <td>{{netCurrentAsset}}</td>

                    </tr>
                    <tr>
                        <td class="font-weight-bold" colspan="3">(5) Gross Assets-  sub Total- (1+4=)</td>
                        <td>
                            <div class="jer">
                                {{grossAsset}}
                            </div>
                    ...
                    <tr>
                        <td class="font-weight-bold" colspan="4">(6) Long Term Liabilities	</td>
                    </tr>
                   
                    <tr v-for="longTermLiabilite in longTermLiabilites">
                        <td class="pl-4 fs-13" colspan="3"> {{longTermLiabilite?longTermLiabilite.name:''}}</td>
                    ...
                    <!--</tr>-->
                    <tr>
                        <td class="font-weight-bold" colspan="3">Net Asset (5 less 6)</td>
                        <td>
                            <div class="jer">
                                {{netAsset}}
                                </div>
                    ...
                    <tr>
                        <td class="font-weight-bold" colspan="4">CAPITAL ACCOUNT</td>
                    </tr>
                    <tr>
                        <td class="pl-4 fs-13" colspan="3">BALANCE </td>
                        <td>{{capitalAmount}}</td>
                    </tr>
                    <tr>
                        <td class="pl-4 fs-13" colspan="3">PROFIT-</td>
                    ...
                    <tr>
                        <td class="pl-4 fs-13" colspan="3"> </td>
                        <td>{{(Number(capitalAmount)+(Number(totalIncome)-Number(totalExpense)-Number(tax))).toFixed(2)}}</td>
                    </tr>
                    <tr>
                        <td class="pl-4 fs-13" colspan="3"> Dividend-</td>
                        <td>{{withdraw?withdraw.amount:0}}</td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold" colspan="3">BALANCE CARRIED FORWARD</td>
                        <td>
                            <div class="jer">
                                {{
