    ...
    <div>
        <div class="card p-4">
            <div class="col-md-12 mt-3 d-flex justify-content-end">
                ...
                <div class="search-container  mr-1">
                    <button @click.prevent="getData(),searched=true">Search</button>
            ...
            <div class="col-md-9 mx-auto pb-5">
                ...
                <table align="center" id="section-to-print" class="profit_Table">
                    ...
                    <tbody>
                    <tr>
                        <td class="text-uppercase font-weight-bold" colspan="3">Turn Over Sales</td>
                    ...
                    <tr>
                        <td class="font-weight-bold text-right">Total Income  </td>
                        <td>{{totalIncome}}</td>

                    </tr>
                    <tr>
                        <td class="font-weight-bold text-right">Gross Profit  </td>
                        <td>{{totalIncome}}</td>

                    </tr>

                    <tr>
                        <td class="font-weight-bold" colspan="3"> EXPENDITURE: </td>
                    </tr>
                    <tr v-for="expense in expenses">
                        <td class="pl-4 fs-13">{{expense.name}}</td>
                        <td>
                    ...
                    <tr>
                        <td class="font-weight-bold text-right"> Profit Before Tax  </td>
                        <td>{{(totalIncome - totalExpense).toFixed(2)}}</td>

                    </tr>
                    <tr>
                        <td class="text-right">Tax Provision    </td>
                        <td>{{tax.toFixed(2)}}</td>

                    </tr>
                    <tr>
                        <td class="font-weight-bold text-right"> Profit After Tax  </td>
